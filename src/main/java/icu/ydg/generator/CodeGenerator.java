...
public class CodeGenerator {
    ...
    public static void main(String[] args) throws TemplateException, IOException {
        // todo 指定生成参数
        String packageName = "icu.ydg";
        String dataName = "标签搜索次数";
        String dataKey = "tagSearchCount";
        String upperDataKey = "TagSearchCount";
